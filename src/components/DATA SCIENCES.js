...
const DATASCIENCES = () => {
  return (
    <section className="teamsection bg-white">
        ...
        <div className="heading-header mb-4"><h1>Technical Programmes</h1></div>
    <div className="align-items-center row"style={{margin:'40px'}}>
      <div className="col-lg-3">
        <div className="teamImg">
          <img style={{ width: '100%', float: 'left' }}
            src="https://www.dukan.pk/demo/dtemp/ptImg1681280789-74440779575856.png"
            alt=""
            className=""
          />
        </div>
      ...
      <div className="col-lg-9">
        <div className="teametxtBOx">
          <h1>Intermediate Data Science with Machine Learning (9 AM - 2 PM)</h1>
          <p></p>
          <h1 style={{ color: 'rgb(227, 104, 0)' }}>Admission Open</h1>
          
          <p></p>
          <p>This course consists of two parts: 1. Technical Component and 2. Soft Skills Component. </p>
          <p>The Technical component constitutes 2/3rd of the course and provides a comprehensive introduction to the field, covering statistical concepts, programming languages, data analysis, data visualization, predictive modeling, and deep learning. Students will gain hands-on experience with real-world datasets, machine learning algorithms, and popular tools such as TensorFlow and scikit-learn. By the end of the course, you will have the skills and knowledge needed to analyze complex data sets and pursue a career in data science or machine learning.</p>
          <p>The Soft Skills component constitutes 1/3rd of the course where, through experiential learning, participants realize their potential and develop their competence to take on professional responsibilities.</p>
    ...
    <div className="team_one"style={{margin:'40px'}}>
      <div className="align-items-center row">
        <div className="col-lg-3">
          <div className="teamImg">
            <img style={{ width: '100%', float: 'left' }} src="https://www.dukan.pk/demo/dtemp/ptImg1681280546-20815859575800.png" className="" alt="Team Member" />
          </div>
        </div>
        <div className="col-lg-9">
          <div className="teametxtBOx">
            ...
            <p>
              This course provides a comprehensive introduction to artificial intelligence and machine learning, covering their history, features, and applications. You will learn how to set up a development environment using Python and Jupyter Notebook and gain a solid understanding of Python programming for ML, Numpy, and Pandas for data analysis. The course covers topics such as supervised and unsupervised learning, neural networks, convolutional neural networks, and recurrent neural networks. You will also gain practical experience building models with scikit-learn and Keras, and working with advanced topics such as transfer learning, image segmentation, and language modeling. Upon completion, you will be able to build and evaluate AI and machine learning models for various applications.
            </p>
            <a className="viewBtn" href="/programmesDetails/Artificial Intelligence: Machine Learning/11"style={{ textDecoration: 'none', color: 'rgb(227, 104, 0)', border: '1px solid rgb(227, 104, 0)' }}>View Details</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="team_one"style={{margin:'40px'}}>
      <div className="align-items-center row">
        <div className="col-lg-3">
          <div className="teamImg">
            <img style={{ width: '100%', float: 'left' }}  src="https://www.dukan.pk/dtemp/ptImg1686913409-46747449575919.png" alt="Course" />
          </div>
        </div>
        <div className="col-lg-9">
          <div className="teametxtBOx">
            <h5>Intermediate Data Science with Machine Learning (2:30 PM - 7:30 PM)</h5>
            <p></p>
            <h1 style={{ color: 'rgb(227, 104, 0)' }}>Admission Open</h1>
            <p></p>
            <p>This course consists of two parts: 1. Technical Component and 2. Soft Skills Component.</p>
            <p>The Technical component constitutes 2/3rd of the course and provides a comprehensive introduction to the field, covering statistical concepts, programming languages, data analysis, data visualization, predictive modeling, and deep learning. Students will gain hands-on experience with real-world datasets, machine learning algorithms, and popular tools such as TensorFlow and scikit-learn. By the end of the course, you will have the skills and knowledge needed to analyze complex data sets and pursue a career in data science or machine learning.</p>
            <p>The Soft Skills component constitutes 1/3rd of the course where, through experiential learning, participants realize their potential and develop their competence to take on professional responsibilities.</p>
            <a className="viewBtn" href="/programmesDetails/Intermediate Data Science with Machine Learning (2:30 PM - 7:30 PM)/19"style={{ textDecoration: 'none', color: 'rgb(227, 104, 0)' , border: '1px solid rgb(227, 104, 0)'}}>View Details</a>
          </div>
        </div>
      </div>
    </div>
