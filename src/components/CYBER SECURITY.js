          ...
          <div className="align-items-center row">
            <div className="col-lg-3">
              <div className="teamImg">
                <img style={{ width: '100%', float: 'left' }}
                  src="https://www.dukan.pk/demo/dtemp/ptImg1681280513-56917359575115.png"
                  alt="Course"
                />
              </div>
            </div>
            <div className="col-lg-9">
              <div className="teametxtBOx">
                <h1>Cyber Security (9 AM - 2 PM)</h1>
                <p></p>
                ...
                <p>
                  The Technical component constitutes 2/3rd of this introductory
                  level course and provides foundational knowledge and skills in
                  cybersecurity and web application security. Topics covered
                  include cybersecurity principles and policies, common threats
                  and attacks, ethical hacking and penetration testing,
                  networking fundamentals, web application architecture,
                  vulnerability assessment, and remediation. The course concludes
                  with a final project in which you will conduct a comprehensive
                  security assessment of a web application, focusing on OWASP Top
                  10 vulnerabilities.
                </p>
                <p>
                  The Soft Skills component constitutes 1/3rd of the course where,
                  through experiential learning, participants realize their
                  potential and develop their competence to take on professional
                  responsibilities.
                </p>
                <a className="viewBtn" href="/programmesDetails/Intermediate Data Science with Machine Learning (9 AM - 2 PM)/6" style={{ textDecoration: 'none',color:'black',backgroundColor:'lightskyblue',margin:'20px'}}>View Details</a>
              </div>
            </div>
          </div>
        </div>
