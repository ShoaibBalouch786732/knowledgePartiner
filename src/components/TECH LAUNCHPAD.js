...
<section className="teamsection bg-white">
        ...
        <div className="team_one"style={{margin:'40px'}}>
          <div className="align-items-center row">
            <div className="col-lg-3">
              ...
              src="https://www.dukan.pk/dtemp/ptImg1686833156-89886396628870.jpg"
              alt=""
              className=""
            />
              </div>
            ...
            <div className="col-lg-9">
              <div className="teametxtBOx">
                <h2>Introduction to Programming (4:30 PM - 7:30 PM) (Admission Open)</h2>
                <p>Admission Open</p>
                <p>
                  Discover the world of programming through our “Intro to Programming course. This beginner-friendly
                  course equips you with a strong foundation in programming concepts and problem-solving skills.
                  Gain proficiency in the Python programming language and get introduced to structured query
                  language (SQL) for data manipulation. Get the opportunity to explore the essentials of web
                  development and learn about project management tools, version control, and collaboration. With
                  hands-on projects and practical examples, this course empowers you to unlock your potential of
                  coding, setting you up to be able to take further courses in web development and data science.
                </p>
                <a className="viewBtn" href="/programmesDetails/Introduction to Programming (4:30 PM - 7:30 PM) (Admission Open)/13" style={{ textDecoration: 'none' }}>View Details</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="align-items-center row">
        ...
        <div className="col-lg-9">
          <div className="teametxtBOx">
            <h2>Introduction to Data Science and Artificial Intelligence (4:30 PM - 7:30 PM)</h2>
            <p></p>
            <h1 style={{ color: 'rgb(227, 104, 0)' }}>Admission Open</h1>
            <p></p>
            <p>Step into the world of data science with this course designed for people who do not have a programming background. We will guide you through the fundamental principles and techniques of data analysis, storytelling, and data manipulation. You will gain hands-on experience in using essential tools like Excel and PowerBI to unlock the hidden insights within datasets. Learn how to analyze, clean, and visualize data effectively, and develop the skills to present your findings in a compelling and impactful manner. Join us to unlock the power of data science to drive informed decision-making and create meaningful narratives from data.</p>
            <a className="viewBtn" href="/programmesDetails/Introduction to Data Science and Artificial Intelligence (4:30 PM - 7:30 PM)/15" style={{ textDecoration: 'none' }}>View Details</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="team_one"style={{margin:'40px'}}>
      <div className="align-items-center row">
        <div className="col-lg-3">
          <div className="teamImg">
            <img style={{ width: '100%', float: 'left' }}
              src="https://www.dukan.pk/dtemp/ptImg1692777034-67171166628569.jpg"
              alt=""
              className=""
            />
          </div>
        ...
        <div className="col-lg-9">
          <div className="teametxtBOx">
            <h5>Introduction to Programming (9 AM - 12 PM) (Admission Open)</h5>
            <p></p>
            <h1 style={{ color: 'rgb(227, 104, 0)' }}>Admission Open</h1>
            <p></p>
            <p>Discover the world of programming through our “Intro to Programming course. This beginner-friendly
              course equips you with a strong foundation in programming concepts and problem-solving skills.
              Gain proficiency in the Python programming language and get introduced to structured query
              language (SQL) for data manipulation. Get the opportunity to explore the essentials of web
              development and learn about project management tools, version control, and collaboration. With
              hands-on projects and practical examples, this course empowers you to unlock your potential of
              coding, setting you up to be able to take further courses in web development and data science.</p>
              <a className="viewBtn" href="/programmesDetails/Introduction to Programming (9 AM - 12 PM) (Admission Open)/21" style={{ textDecoration: 'none' }}>View Details</a>
          </div>
        </div>
      </div>
    </div>
